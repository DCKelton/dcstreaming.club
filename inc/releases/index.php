...
// Add link for Home
if ($plppConfiguration['usersettings']['home_link']) {$plppOutput['Menu'] .= '<li class="plpp_menu"><a href="https://mystreamnet.club"><span class="plpp_menu plpp_menu_home">Back Home</span></a></li>'.PHP_EOL;}
...
if ($plppIsSearch) {
	...
	if (empty($plppItem)) {
		...
		$plppItems['episode'] = $plex->getRecentlyAdded('season');
